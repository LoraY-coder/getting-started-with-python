class PersonalAssistant:
    ...
    def get_birthday(self, name):
      if name in self.birthdays:
        return f"{name}'s birthday is on {self.birthdays.get(name)}."
      else:
        return "No birthday with that name!"
      
    def add_birthday(self, name, date):
      if name in self.birthdays:
        return f'There already is a birthday for {name}'
      else:
        self.birthdays[name] = [date]
        return f"{name}'s birthday was entered."
    ...
    def remove_birthday(self, name):
      if name in self.birthdays:
        ...
        return f"{name}'s birthday was not on list."
